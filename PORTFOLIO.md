...
thumbnail: "/images/expatdrive__thumb.webp"
slides:
  - src: "/images/expat_driving_01.webp"
    alt_en: "Product overview — mobile study session with road sign quiz and bilingual interface"
    alt_es: "Vista general del producto — sesion de estudio movil con quiz de senales viales e interfaz bilingue"
  - src: "/images/expat_driving_02.webp"
    alt_en: "Three-layer architecture diagram — UX, product logic, and infrastructure with skills demonstrated"
    alt_es: "Diagrama de arquitectura en tres capas — UX, logica de producto e infraestructura con habilidades demostradas"
  - src: "/images/expat_driving_03.webp"
    alt_en: "Before and after comparison — legacy PDFs and hostile sites vs clean bilingual ExpatDrive dashboard"
    alt_es: "Comparacion antes y despues — PDFs obsoletos y sitios hostiles vs panel limpio y bilingue de ExpatDrive"
  - src: "/images/expat_driving_04.webp"
    alt_en: "SM-2 spaced repetition cycle diagram — review, score, update interval, schedule next review"
    alt_es: "Diagrama del ciclo de repeticion espaciada SM-2 — revisar, calificar, actualizar intervalo, programar siguiente repaso"
  - src: "/images/expat_driving_05.webp"
    alt_en: "Readiness scoring dashboard showing 72% pass probability with category-level knowledge breakdown"
    alt_es: "Panel de puntuacion de preparacion mostrando 72% de probabilidad de aprobar con desglose por categoria"
  - src: "/images/expat_driving_06.webp"
    alt_en: "Edge case handling — general exam and Jalisco simulator mode with attention to state-specific requirements"
    alt_es: "Manejo de casos especiales — examen general y modo simulador de Jalisco con atencion a requisitos estatales"
video_url: "/video/expatDrive-brief.mp4"
video_poster: "/images/expatDrive-pitch-poster.webp"

live_url: "https://getexpatdrive.com"
demo_url: "https://getexpatdrive.com/countries/mexico/jalisco/"
case_study_url: ""
